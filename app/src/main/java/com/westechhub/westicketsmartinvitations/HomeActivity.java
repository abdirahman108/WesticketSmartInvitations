...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        file_maps.put("Step 2 point the camera ",R.drawable.westech);
        file_maps.put(" Amoud University Bus",R.drawable.invbtn);
        file_maps.put("Welcome to Amoud Universty",R.drawable.sax);
        file_maps.put("AMOUD UNIVERSITY",R.drawable.flash_off);
        file_maps.put("Big stage Of Amoud University",R.drawable.invbtn);
        file_maps.put("Amoud University",R.drawable.sax);
